...
if (version_compare(_PS_VERSION_, '1.6', '<'))
	$order_filename = "order.php?step=3";
...
//added by DB
if ($bluepaid->isSecure($POU_requestProtocol))
{
	$params['set_secure_return'] = 1;
	$params['set_secure_conf'] = 1;
	//$params['url_retour_bo'] = 'paiement-securise.bluepaid.com/services/bp_secure_return_customer.php';
	$params['url_retour_bo'] = 'paiement-securise.bluepaid.com/services/bp_return_customer.php';
}
else
{
	$params['set_secure_return'] = 0;
	$params['set_secure_conf'] = 0;
	$params['url_retour_bo'] = 'paiement-securise.bluepaid.com/services/bp_return_customer.php';
}

$url_params = http_build_query($params);
//Test de la variable HTTP_HOST
/*$log  = "Log time: ".date("F j, Y, g:i a").PHP_EOL.
	"VARIABLE HOST : ".$_SERVER['HTTP_HOST'].PHP_EOL.
	"VARIABLE URL PARAMS : ".$url_params.PHP_EOL.
	"-------------------------";
//Save string to log, use FILE_APPEND to append.
file_put_contents('../../logs/sendToBPI_log_'.date("j.n.Y").'.txt', $log, FILE_APPEND);*/
