    ...
    <div class="row">
        <div class="col-xs-12 col-md-12">
            <p class="payment_module bluepaid">
                <a href="{$modules_dir|escape:'html':'UTF-8'}bluepaid/controllers/payment/sendtoBPI.php?payment=1" title="{l s='Credit card payment by Bluepaid' mod='bluepaidmulti'}">
...
{if $bluepaid_multipayment}
    <div class="row">
        <div class="col-xs-12 col-md-12">
            <p class="payment_module bluepaid">
                <a href="{$modules_dir|escape:'html':'UTF-8'}bluepaid/controllers/payment/sendabotoBPI.php?payment=1" title="{l s='Credit card payment by Bluepaid' mod='bluepaidmulti'}">
